...
const BentoCard = ({src,title,description,isComingSoon})=>{
     ...
     <div className='relative size-full'>
        ...
        {isComingSoon &&(
            <div className='relative bottom-16 -right-5 z-10 '>
                <Button title="coming soon" containerClass="!text-blue-50 !inline-flex gap-3 px-12 !bg-gray-700" lIcon={<TiLocationArrow className='scale-150'/>}/>
            </div>
        )}
      ...
      <div className='container mx-auto px-3 md:px-10'>
            <div className='px-5 py-32'>
                ...
                <p className='max-w-md font-circular-web text-lg text-blue-50 opacity-50'>Immerse yourself in a rich and ever-expanding 
                    universe where a vibrant array of products 
            ...
            <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
                ...
                <BentoTilt className='bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0'>
                    ...
                    title={<>n<b>e</b>xus</>}
                    description="The game of games merging your in-game actions across web2 & web3 titles into a rewarding adventure."
                    isComingSoon
                    />
                </BentoTilt>
